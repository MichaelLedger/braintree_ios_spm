...
@property (nonatomic, copy) NSString * _Nonnull returnURLScheme SWIFT_DEPRECATED_MSG("returnURLScheme is deprecated and will be removed in a future version. Use BTVenmoClient(apiClient:universalLink:).");
/// :nodoc: This method is exposed for internal Braintree use only. Do not use. It is not covered by Semantic Versioning and may change or be removed at any time.
/// Property for <code>returnURLScheme</code>. Created to avoid deprecation warnings upon accessing
/// <code>returnURLScheme</code> directly within our SDK. Use this value instead.
@property (nonatomic, copy) NSString * _Nonnull _returnURLScheme;
/// Determine whether the return URL can be handled.
/// <ul>
///   <li>
...
@interface BTClientToken : NSObject <NSCopying, NSSecureCoding>
