...
@property (nonatomic, copy) NSString * _Nullable shopperSessionID;
...
@property (nonatomic, copy) NSURL * _Nullable shippingCallbackURL;
...
///
/// \param amount Required: Used for a one-time payment. Amount must be greater than or equal to zero, may optionally contain exactly 2 decimal places separated by ‘.’ and is limited to 7 digits before the decimal point.
///
...
///
- (nonnull instancetype)initWithUserAuthenticationEmail:(NSString * _Nonnull)userAuthenticationEmail enablePayPalAppSwitch:(BOOL)enablePayPalAppSwitch amount:(NSString * _Nonnull)amount intent:(enum BTPayPalRequestIntent)intent userAction:(enum BTPayPalRequestUserAction)userAction offerPayLater:(BOOL)offerPayLater currencyCode:(NSString * _Nullable)currencyCode requestBillingAgreement:(BOOL)requestBillingAgreement;
...
/// during checkout. Defaults to <code>false</code>.
///
/// \param shippingCallbackURL Optional: Server side shipping callback URL to be notified when a customer updates their shipping address or options.
...
///
- (nonnull instancetype)initWithAmount:(NSString * _Nonnull)amount intent:(enum BTPayPalRequestIntent)intent userAction:(enum BTPayPalRequestUserAction)userAction offerPayLater:(BOOL)offerPayLater currencyCode:(NSString * _Nullable)currencyCode requestBillingAgreement:(BOOL)requestBillingAgreement shippingCallbackURL:(NSURL * _Nullable)shippingCallbackURL userAuthenticationEmail:(NSString * _Nullable)userAuthenticationEmail OBJC_DESIGNATED_INITIALIZER;
/// :nodoc: Exposed publicly for use by PayPal Native Checkout module. This method is not covered by semantic versioning.
- (NSDictionary<NSString *, id> * _Nonnull)parametersWith:(BTConfiguration * _Nonnull)configuration universalLink:(NSURL * _Nullable)universalLink isPayPalAppInstalled:(BOOL)isPayPalAppInstalled SWIFT_WARN_UNUSED_RESULT;
@end
...
/// \param userAuthenticationEmail Optional: User email to initiate a quicker authentication flow in cases where the user has a PayPal Account with the same email.
///
/// \param enablePayPalAppSwitch Optional: Used to determine if the customer will use the PayPal app switch flow. Defaults to <code>false</code>.
///
- (nonnull instancetype)initWithOfferCredit:(BOOL)offerCredit userAuthenticationEmail:(NSString * _Nullable)userAuthenticationEmail enablePayPalAppSwitch:(BOOL)enablePayPalAppSwitch OBJC_DESIGNATED_INITIALIZER;
/// :nodoc: Exposed publicly for use by PayPal Native Checkout module. This method is not covered by semantic versioning.
- (NSDictionary<NSString *, id> * _Nonnull)parametersWith:(BTConfiguration * _Nonnull)configuration universalLink:(NSURL * _Nullable)universalLink isPayPalAppInstalled:(BOOL)isPayPalAppInstalled SWIFT_WARN_UNUSED_RESULT;
@end
...
- (NSDictionary<NSString *, id> * _Nonnull)parametersWith:(BTConfiguration * _Nonnull)configuration universalLink:(NSURL * _Nullable)universalLink isPayPalAppInstalled:(BOOL)isPayPalAppInstalled SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithOfferCredit:(BOOL)offerCredit userAuthenticationEmail:(NSString * _Nullable)userAuthenticationEmail enablePayPalAppSwitch:(BOOL)enablePayPalAppSwitch SWIFT_UNAVAILABLE;
@end
